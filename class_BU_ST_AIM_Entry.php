       ...
       /*var_dump( $doc_form['fields'] );
        ...
        foreach ($doc_entries as $entry) {
          ...
          if ( $entry['5'] != '') {//hasn't been viewed
            if ( $entry['24'] == '' )
              ...
              if ($entry['24'] != "Approved" && $application_entry['107'] == 'true') {
                  ...
                  $review_status_html .= '<li>' . $entry['24'] . ': <a href="' . $entry['5'] . '" target="_blank">' . $doc_form['fields']['4']['label'] . '</a><br>';
            ...
            $review_status_html .= '<input type="hidden" name="' . $doc_form['fields']['23']['adminLabel'] . '_' . $entry['id'] . '" value="">';
          ...
          if ( $entry['6'] != '' ) {
            ...
            $review_status_html .= '<li>' . $entry['25'] . ': <a href="' . $entry['13'] . '" target="_blank">' . $doc_form['fields']['6']['label'] . '</a><br>';
          ...
          if ( $entry['8'] != '' ) {
            ...
            $review_status_html .= '<li>' . $entry['23'] . ': <a href="' . $entry['8'] . '" target="_blank">' . $doc_form['fields']['9']['label'] . '</a><br>';
          ...
          if ( $entry['11'] != '' ) {
            ...
            $review_status_html .= '<li>' . $entry['26'] . ': <a href="' . $entry['8'] . '" target="_blank">' . $doc_form['fields']['8']['label'] . '</a><br>';

            $review_status_html .= '<input type="checkbox" name="' . $doc_form['fields']['25']['adminLabel'] . '_' . $entry['id'] . '" value="true"';
            ...
            $review_status_html .= '<input type="checkbox" name="' . $doc_form['fields']['25']['adminLabel'] . '_' . $entry['id'] . '" value="false"';
            if ($entry['26'] == 'Denied') {
              $review_status_html .= ' checked';
            }
          ...
          if ( $entry['10'] != '' ) {
            ...
            $review_status_html .= '<li>' . $entry['27'] . ': <a href="' . $entry['10'] . '" target="_blank">' . $doc_form['fields']['10']['label'] . '</a><br>';

           $review_status_html .= '<input type="checkbox" name="' . $doc_form['fields']['26']['adminLabel'] . '_' . $entry['id'] . '" value="true"';
            ...
            $review_status_html .= '<input type="checkbox" name="' . $doc_form['fields']['26']['adminLabel'] . '_' . $entry['id'] . '" value="false"';
            if ($entry['27'] == 'Denied') {
              $review_status_html .= ' checked';
            }
            ...
            $review_status_html .= '<li>' . $doc_form['fields']['10']['label'] . ' Not Received<br>';
