...
<div class="error-404 not-found content-area">
	...
	<header class="page-header">
		...
		<canvas id='canvas' class="page-not-found-banner"  height="200px"><img src="/andrew/files/2018/05/page-not-found-interactive-banner.png"></canvas>
	</div>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		</div><?php responsive_search_form(); ?>
