...
responsive_framework.galleries = function ($) {
  ...
  return {
    ...
    initialize_lightgallery: function initialize_lightgallery() {
      (0, _lightgallery.default)(document.querySelector('.gallery'), {
        plugins: [_thumbnail.default],
...
},{"@babel/runtime/helpers/interopRequireDefault":2,"lightgallery":3,"lightgallery/plugins/thumbnail":4}],2:[function(require,module,exports){
